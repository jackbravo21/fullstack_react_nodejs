...
export default function Products() {
    ...
    useEffect(() => {
        ...
        dispatch(fetchProducts({ type: "plates" }));
    }, [dispatch]);
    ...
    if (loading) {
        return <div className='commumtitle'>Carregando pratos...</div>;
    }

    return (
        <div style={{marginBottom: '65px'}} className="containerSection">
            <h2 className="commumtitle">Pratos:</h2>

            {products.length === 0 && <p>Não há pratos disponíveis.</p>}
